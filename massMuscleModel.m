...
pennationAngle 	   = (muscleParameters(4)*pi)/180;
...
%Set up Controller
initialTime = 0.0;
finalTime = analysisParameters(analysisParameters(10));
...
slopeAndIntercept.setitem(0, analysisParameters(11)/(finalTime-initialTime)); % Default
slopeAndIntercept.setitem(1,  analysisParameters(12)); % Default
